...
export const documentStatus = ({
  ...
  if (
    ...
    if (status === "ONGOING") {
      if (role === "owner" && signatory_status === "COMPLETED") {
        kata = "ONGOING";
        color = "yellow";
      }
      if (role === "SIGNER" && signatory_status === "PENDING") {
      ...
      if (role === "REVIEWER" && signatory_status === "PENDING") {
...
export const serializeStamp = (data) => {
  return {
